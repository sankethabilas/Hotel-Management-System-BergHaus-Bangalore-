    ...
    async function fetchSupplierData() {
      try {
        ...
        if (res.data.success) {
          ...
          const supplierItems = res.data.existingItems.filter((item: InventoryItem) => 
          ...
          if (supplierItems.length > 0) {
            ...
            setSupplier({
              name: firstItem.supplierName || decodedName,
      ...
      <div>
        ...
        <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
          <div className="text-center">
            ...
            <Link href="/admin/inventory/suppliers" className="text-blue-600 hover:text-blue-800 font-medium">
              ← Back to Suppliers
            </Link>
          </div>
        </div>
    ...
    <div>
      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="text-center mb-8">
          ...
          <div className="mt-4">
            <Link href="/admin/inventory/suppliers" className="text-blue-600 hover:text-blue-800 text-sm sm:text-base font-medium">
              ← Back to Suppliers
            </Link>
          </div>
        </div>
                    ...
                    <tr key={item._id} className="hover:bg-gray-50">
                      <td className="border border-gray-200 p-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <Link href={`/admin/inventory/items/${item._id}`} className="text-blue-600 hover:text-blue-800 font-medium">
                              {item.name}
                            </Link>
                            <p className="text-sm text-gray-500">{item.description?.slice(0, 50)}{item.description && item.description.length > 50 ? '...' : ''}</p>
                          </div>
                        </div>
                      </td>
                      <td className="border border-gray-200 p-3">
                      ...
                      <td className="border border-gray-200 p-3 text-center">
                        <Link 
                          href={`/admin/inventory/items/${item._id}`}
