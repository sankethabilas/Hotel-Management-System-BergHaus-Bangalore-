...
import { getItem } from "../../../../../lib/inventoryApi";
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="text-center mb-8">
        ...
        <div className="mt-4">
          <Link href="/admin/inventory/items" className="text-blue-600 hover:text-blue-800 text-sm sm:text-base font-medium">
            ← Back to Inventory
          </Link>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Link 
          href={`/admin/inventory/items/${item._id}/edit`}
