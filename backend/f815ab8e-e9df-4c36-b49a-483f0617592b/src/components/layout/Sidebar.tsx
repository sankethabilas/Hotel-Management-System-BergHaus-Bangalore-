...
const Sidebar = () => {
  return <div className="w-64 h-full bg-navy-blue text-white flex flex-col">
      {/* Logo */}
...
const NavItem = ({
  ...
  return <NavLink to={to} className={({
    isActive
  }) => `flex items-center px-5 py-3 text-sm ${isActive ? 'bg-navy-blue-dark text-gold border-l-4 border-gold' : 'text-gray-300 hover:bg-navy-blue-light'}`}>
